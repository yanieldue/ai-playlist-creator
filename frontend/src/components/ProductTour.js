    ...
    <div style={{ padding: '12px' }}>
      <div className="playlist-card tour-playlist-card" style={{ padding: '12px 14px' }}>
        ...
        <div className="tour-dropdown-menu" style={{ borderRadius: 8, padding: '4px 0', fontSize: 12 }}>
          ...
          <div style={{ padding: '6px 12px', display: 'flex', alignItems: 'center', gap: 8, color: '#ff3b30' }}>
            <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2">
...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Tap the ⋮ menu on any playlist and select Edit Playlist to manage it. Lock any song to keep it from being removed during refreshes. Unlock it anytime to let it rotate out naturally.',
    diagram: null,
