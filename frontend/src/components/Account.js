                ...
                <div className="form-group">
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <button
                      ...
                      style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: '#8e8e93', padding: 0, display: 'flex', alignItems: 'center' }}
                    >
                      {showEmailPassword ? (
